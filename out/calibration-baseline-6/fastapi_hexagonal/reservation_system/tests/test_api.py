...
from reservation_system.config import Settings
from reservation_system.main import create_app
...
def test_list_with_api_key() -> None:
    ...
    assert client.get("/reservations", headers=headers).status_code == 200
