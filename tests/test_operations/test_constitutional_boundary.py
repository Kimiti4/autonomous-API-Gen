"""
Constitutional boundary enforcement for Operational Intelligence.
"""
...
def _get_all_operations_modules():
    import constitutional_architecture.operations
    modules = []
    for importer, modname, ispkg in pkgutil.walk_packages(
        constitutional_architecture.operations.__path__,
        prefix="constitutional_architecture.operations.",
    ):
...
class TestConstitutionalBoundary:
    def test_no_engine_imports(self):
        violations = []
        for mod_name in _get_all_operations_modules():
            try:
